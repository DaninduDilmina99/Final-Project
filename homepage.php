    ...
    <body>
        ...
        <section id="section0" class="slider-area">
            <div class="main-slider owl-theme owl-carousel">
                <div class="single-slide item slider-set" style="background-image: url(img/slider/6.jpg)">

                    <div class="background-dark">

                    </div>
                  <div  class="slider-content-area-1">
                    <div class="row">
                ...
                <div class="single-slide item slider-set" style="background-image: url(img/slider/2.jpeg)">

                    
                    <div class="background-dark">

                    </div>
                  <div  class="slider-content-area-2">
                    <div class="row">
                      <div class="slide-content-wrapper text-center">
                        <div class="slide-content">
                          ...
                          <h2>A Taste Of  The Good Life</h2>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sagittis leo vitae lacinia congue.</p>
                          <a class="default-btn2 learn-more" href="about.html">BOOKING</a>
                ...
                <div class="single-slide item slider-set" style="background-image: url(img/slider/3.jpeg)">
                  ...
                  <div  class="slider-content-area-3">
                    <div class="row">
                      <div class="slide-content-wrapper text-center">
                        <div class="slide-content">
                          ...
                          <h2>A Taste Of  The Good Life</h2>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sagittis leo vitae lacinia congue.</p>
                          <a class="default-btn3 learn-more" href="about.html" >DONATE</a>
