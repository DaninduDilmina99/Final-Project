                      ...
                      <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          <ul class="nav navbar-nav navbar-right navBar">
                            <li class="nav-item"><a href="index.html" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Home </a></li>
                            <li class="nav-item"><a href="" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Bus Shedule</a></li>
                            <li class="nav-item"><a href="" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Booking</a></li>
                            <li class="nav-item"><a href="" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Donate</a></li>
                            <li class="nav-item"><a href="reviews.html" class="active nav-link text-uppercase font-weight-bold js-scroll-trigger">Review</a></li>
